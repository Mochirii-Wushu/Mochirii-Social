...
class AvatarController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'avatar' => AvatarUploadPolicy::validationRule(),
        ], [
            'avatar.mimetypes' => 'The avatar must be a JPEG, PNG, or WebP image.',
            'avatar.max' => 'The avatar exceeds the file size limit of '.PrettyNumber::size(AvatarUploadPolicy::maxSizeKb(), true, false).'.',
        ]);
