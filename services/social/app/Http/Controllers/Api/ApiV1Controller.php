...
class ApiV1Controller extends Controller
{
    ...
    public function accountUpdateCredentials(Request $request)
    {
        ...
        $this->validate($request, [
            'avatar' => AvatarUploadPolicy::validationRule('sometimes'),
            ...
            'avatar.mimetypes' => 'The file must be a JPEG, PNG, or WebP image',
            'avatar.max' => 'The :attribute exceeds the file size limit of '.PrettyNumber::size(AvatarUploadPolicy::maxSizeKb(), true, false),
        ]);
    ...
    public function mediaUpload(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'file.mimetypes' => $this->unsupportedImageUploadMessage(),
            'file.*.mimetypes' => $this->unsupportedImageUploadMessage(),
        ]);
        ...
        if (in_array($photo->getMimeType(), $mimes) == false) {
            abort(400, $this->unsupportedImageUploadMessage());
        }
