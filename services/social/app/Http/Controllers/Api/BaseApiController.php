...
class BaseApiController extends Controller
{
    ...
    public function avatarUpdate(Request $request)
    {
        ...
        $this->validate($request, [
            'upload' => AvatarUploadPolicy::validationRule(),
        ], [
            'upload.mimetypes' => 'The avatar must be a JPEG, PNG, or WebP image.',
            'upload.max' => 'The avatar exceeds the file size limit of '.PrettyNumber::size(AvatarUploadPolicy::maxSizeKb(), true, false).'.',
        ]);
