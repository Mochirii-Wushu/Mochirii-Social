...
<head>
	...
	<link rel="shortcut icon" type="image/png" href="{{url('/img/mochirii-icon.png')}}">
...
<head>
	...
	<meta name="theme-color" content="#172a23">
	<meta name="apple-mobile-web-app-capable" content="yes">
	<link rel="shortcut icon" type="image/png" href="/img/mochirii-icon.png">
	<link rel="apple-touch-icon" type="image/png" href="/img/mochirii-icon.png">
	<link rel="canonical" href="{{url(request()->url())}}">
	<link href="{{ mix('css/app.css') }}" rel="stylesheet" data-stylesheet="light">
	<script type="text/javascript">window._sharedData = {curUser: {}, version: 0}; window.App = {config: {!!App\Util\Site\Config::json()!!}};</script>
	@stack('styles')
