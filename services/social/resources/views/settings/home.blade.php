...
@section('section')
@php($avatarPolicy = \App\Services\AvatarUploadPolicy::config())
			...
			<div class="collapse" id="avatarCollapse">
				...
				<div class="card card-body">
					<div class="custom-file mb-1">
						<input type="file" name="avatar" class="custom-file-input" id="avatarInput" accept="{{$avatarPolicy['media_types']}}">
...
$(document).ready(function() {
		...
		$('#maxAvatarSize').text(filesize({{$avatarPolicy['max_size'] * 1024}}, {round: 0}));
