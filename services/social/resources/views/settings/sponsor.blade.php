...
<form method="post" action="{{route('settings.sponsor')}}">
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<input type="text" class="form-control" id="patreon" name="patreon" placeholder="patreon.com/mochirii" value="{{$sponsors['patreon']}}">
			<p class="help-text small text-muted font-weight-bold">
				Example: patreon.com/mochirii
			</p>
		</div>
	</div>
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<input type="text" class="form-control" id="liberapay" name="liberapay" placeholder="liberapay.com/mochirii" value="{{$sponsors['liberapay']}}">
			<p class="help-text small text-muted font-weight-bold">
				Example: liberapay.com/mochirii
			</p>
		</div>
	</div>
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<input type="text" class="form-control" id="opencollective" name="opencollective" placeholder="opencollective.com/mochirii" value="{{$sponsors['opencollective']}}">
			<p class="help-text small text-muted font-weight-bold">
				Example: opencollective.com/mochirii
			</p>
		</div>
	</div>
	<hr>
