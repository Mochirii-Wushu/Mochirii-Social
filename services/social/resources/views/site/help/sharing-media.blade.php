	...
	<p>
		...
		<div class="collapse" id="collapse5">
			<div>
				...
				<p class="small text-muted"><i class="fas fa-info-circle mr-1"></i> Image descriptions improve accessibility for guild members.</p>
			</div>
		</div>
	</p>
	<p>
	...
	<p>
		...
		<div class="collapse" id="collapse12">
			<div>
				...
				<br />
				<strong class="text-danger">Archived posts cannot be deleted or otherwise interacted with while they remain archived.</strong>
				<br />
			</div>
		</div>
	</p>
