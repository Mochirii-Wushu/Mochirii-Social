...
<p>
  ...
  <div class="collapse" id="collapse1">
    <div>
      <p>Direct messages let you send messages to another account. You can send the following things as a message:</p>
      <ul>
        <li>
      ...
      <p>To see messages you've sent, tap <i class="far fa-comment-dots"></i> in the top right of feed. From there, you can manage the messages you've sent and received.</p>
      <p>Photos or videos sent in direct messages stay out of hashtag and location pages. Recipients can still save or re-share what they receive, so use direct messages thoughtfully.</p>
    </div>
  </div>
</p>
{{-- <p>
  <a class="text-dark font-weight-bold" data-toggle="collapse" href="#collapse2" role="button" aria-expanded="false" aria-controls="collapse2">
    <i class="fas fa-chevron-down mr-2"></i>
    How do I manage direct messages I've received?
  </a>
...
<p>
  <a class="text-dark font-weight-bold" data-toggle="collapse" href="#collapse3" role="button" aria-expanded="false" aria-controls="collapse3">
    <i class="fas fa-chevron-down mr-2"></i>
    How do I unsend a direct message?
  </a>
...
<p>
  <a class="text-dark font-weight-bold" data-toggle="collapse" href="#collapse4" role="button" aria-expanded="false" aria-controls="collapse4">
    <i class="fas fa-chevron-down mr-2"></i>
    Can I send direct messages to people I am not following?
  </a>
...
<p>
  <a class="text-dark font-weight-bold" data-toggle="collapse" href="#collapse5" role="button" aria-expanded="false" aria-controls="collapse5">
    <i class="fas fa-chevron-down mr-2"></i>
    How do I report content that I've received in a direct message?
  </a>
