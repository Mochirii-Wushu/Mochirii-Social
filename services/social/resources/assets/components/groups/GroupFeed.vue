						...
						<div v-if="group.self.is_member">
							...
							<div v-else class="group-timeline">
								...
								<!-- <div class="status-card-component shadow-sm mb-3 rounded-lg">
								    <div class="card shadow-none border rounded-0">
								        <div class="card-body pb-0">
								            <div class="media">
								                <img src="https://social.mochirii.com/storage/avatars/321493203255693312/5a6nqo.jpg?v=2" width="42px" height="42px" onerror="this.onerror=null;this.src='/storage/avatars/default.png?v=2'" alt="avatar" class="rounded-circle box-shadow mr-2">

								                <div class="media-body">
								                    <div class="pl-2 d-flex align-items-top">
								                        <div>
								                            <p class="mb-0">
								                                <a href="https://social.mochirii.com/dansup" class="username font-weight-bold text-dark text-decoration-none text-break">
								                                    dansup
								                                </a>
								                            </p>

								                            <p class="mb-0">
								                                <a href="https://social.mochirii.com/groups/328821658771132416/329186991407239168" class="font-weight-light text-muted small">13h</a>
									...
									<p class="pt-2 text-break" style="font-size: 15px;">
								                        ...
								                        <div class="my-3 row px-0 mx-0 card card-body my-0 py-0 border shadow-none">
																																	<img src="/img/mochirii-social-card.png" class="img-fluid">
									<div class="bg-light px-3 pt-2 pb-3">
																																		<p class="text-muted mb-0 small">MOCHIRII SOCIAL</p>
																																		<p class="mb-0" style="font-size: 16px;font-weight:500;">Mochirii Social staging update</p>
																																		<p class="mb-0 text-muted" style="font-size:14px;line-height:15px;">Private guild social preview</p>
									</div>
								                        </div>
								...
								<!-- <div class="status-card-component shadow-sm mb-3 rounded-lg">
									...
									<div class="col px-0">
																																		<img src="https://social.mochirii.com/img/sample-post.jpeg" class="img-fluid border rounded-lg">
									</div>
									<div class="col px-0">
																																		<img src="https://social.mochirii.com/img/sample-post.jpeg" class="img-fluid border rounded-lg">
									</div>
