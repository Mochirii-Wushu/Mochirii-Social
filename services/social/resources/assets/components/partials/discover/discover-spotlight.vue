				...
				<transition enter-active-class="animate__animated animate__fadeInDownBig" leave-active-class="animate__animated animate__fadeOutDownBig" mode="out-in">
					<div v-if="isLoaded" class="row">
						<div class="col-5">
							...
							<p class="lead font-default mt-4">This week's collection is curated by <span class="primary">@mochirii</span></p>
						</div>
						<div class="col-7 d-flex justify-content-between">
							<div class="text-center mr-4">
								<h5 class="font-default mb-2">@mochirii</h5>
								<img src="/img/mochirii-icon.png" draggable="false" onerror="this.onerror=null;this.src='/storage/avatars/default.png?v=0';" class="avatar shadow cursor-pointer" width="160" height="160">
