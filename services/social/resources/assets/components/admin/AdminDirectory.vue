                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            ...
                            <p class="h3 text-white font-weight-light">Manage your server listing on social.mochirii.com</p>
                        </div>
                                ...
                                <div v-if="tabIndex === 1" class="tab-pane fade show active">
                                        ...
                                        <div class="text-center mb-4">
                                            ...
                                            <div v-else-if="state.is_eligible && !state.submission_exists" class="mb-4">
                                                ...
                                                <button
                                                    ...
                                                    @click="handleSubmit">
                                                    Submit my Server to social.mochirii.com
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div v-else-if="!isSubmitting && !state.awaiting_approval && state.is_active">
                                        <div class="card card-body shadow-none border d-flex align-items-center justify-content-center py-5">
                                            ...
                                            <p class="mt-2 mb-0">Your server directory listing on <a href="#" class="font-weight-bold">social.mochirii.com</a> is active</p>

                                            <button
                                                class="btn btn-primary btn-sm mt-3 font-weight-bold px-5 text-uppercase"
                                                @click="handleSubmit">
                                                Update my listing on social.mochirii.com
                                            </button>
                                        </div>
                                    </div>
