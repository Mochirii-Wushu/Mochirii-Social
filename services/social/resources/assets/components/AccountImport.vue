        ...
        <template v-else>
            ...
            <template v-else-if="page === 'reviewImports'">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="title">
                        <h3 class="font-weight-bold">Imported Posts</h3>
                    </div>
                </div>
                <hr>
                <section class="row mb-n5 media-selector" style="max-height: 600px;overflow-y: auto;">
        ...
        methods: {
            ...
            selectArchive() {
                ...
                swal({
                    ...
                    icon: 'success',
                    text: 'Select the approved data archive provided by the administrators.',
                    buttons: {
                        cancel: "Cancel",
                        danger: {
            ...
            async fixFacebookEncoding(string) {
                // Preserve the legacy archive decoding behavior used by this importer.
                // Preserve the legacy archive decoding behavior used by this importer.
